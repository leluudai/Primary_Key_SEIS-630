...
CREATE TABLE LINE_ITEM(
 LineItemID Int GENERATED BY DEFAULT ON NULL AS IDENTITY,
...
CREATE TABLE VEHICLE(
 VehicleID Int GENERATED BY DEFAULT ON NULL AS IDENTITY,
 VIN Char(17) NOT NULL,
 LicensePlate VarChar(7) NULL, -- TODO: CHECK constraint for hypens?
...
CREATE TABLE TOOL(
 ToolID Int GENERATED BY DEFAULT ON NULL AS IDENTITY,
...
CREATE TABLE PROJECT(
 ProjectNumber Int GENERATED BY DEFAULT ON NULL AS IDENTITY,
...
CREATE TABLE SKILL(
 SkillID Int GENERATED BY DEFAULT ON NULL AS IDENTITY,
...
CREATE TABLE EMPLOYEE(
 EmployeeID Int GENERATED BY DEFAULT ON NULL AS IDENTITY,
...
CREATE TABLE CONTRACTOR(
 ContractorNumber Int GENERATED BY DEFAULT ON NULL AS IDENTITY,
 SupplierID Int NOT NULL,
 ProjectNumber Int NOT NULL,
