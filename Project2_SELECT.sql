...
SELECT e.SSN, s.SKILLCODE, s.BASICHOURLYRATE AS RATE, s.FRINGE, (s.BASICHOURLYRATE*1.5 + s.FRINGE) AS TOTAL, t.TOTALTIME, ((s.BASICHOURLYRATE*1.5 + s.FRINGE) * t.TOTALTIME) AS GROSS
FROM EMPLOYEE e
